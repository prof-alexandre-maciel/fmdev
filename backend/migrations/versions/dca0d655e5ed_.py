...
Revision ID: dca0d655e5ed
Revises: 7fff468e2c28
Create Date: 2020-04-18 17:47:45.512499
...
revision = 'dca0d655e5ed'
down_revision = '7fff468e2c28'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('train_models', sa.Column('score', sa.Float(), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('train_models', 'score')
