...
Revision ID: 6f5a7106a0c0
Revises: dca0d655e5ed
Create Date: 2020-04-18 19:18:40.274091
...
revision = '6f5a7106a0c0'
down_revision = 'dca0d655e5ed'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('train_models', 'updated_at',
